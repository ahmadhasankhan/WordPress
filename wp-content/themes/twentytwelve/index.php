...
get_header(); ?>
    ...
    <!--  Second Boxes.-->
    <div class="home_box_container">
        <div class="second_boxes">
            <div class="bottom_box_head">Live Monthly Events
                <hr style="width:30%;height:5px;border:none;color:#B7246A;background-color:#B7246A;margin:0px;margin-top:10px;"/>
            </div>
        ...
        <div class="second_boxes" style="width:330px;">
            <div class="bottom_box_head">Live Market Webinars
<hr style="width:30%;height:5px;border:none;color:#B7246A;background-color:#B7246A;margin:0px;margin-top:10px;"/>
</div>
            <div class="box_content">
                <ul>
        ...
        <div class="second_boxes">
            <div class="bottom_box_head">Products
<hr style="width:30%;height:5px;border:none;color:#B7246A;background-color:#B7246A;margin:0px;margin-top:10px;"/>
</div>
            <div class="box_content">
                <ul>
